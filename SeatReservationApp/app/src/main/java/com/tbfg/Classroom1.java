...
public class Classroom1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.classroom1);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 교실 선택화면으로 이동
                Intent intent = new Intent(Classroom1.this, Campus.class);
    ...
    private void updateButtonDrawable(Button button, int index) {
        if (isHeartFilled[index]) {
            button.setCompoundDrawablesWithIntrinsicBounds(
                    ContextCompat.getDrawable(Classroom1.this, R.drawable.heart_filled),
                    null, null, null);
        } else {
            button.setCompoundDrawablesWithIntrinsicBounds(
                    ContextCompat.getDrawable(Classroom1.this, R.drawable.heart_unfilled),
                    null, null, null);
        }
    }
