...
public class Classroom8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.classroom8);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 교실 선택화면으로 이동
                Intent intent = new Intent(Classroom8.this, Campus.class);
    ...
    private void updateButtonDrawable(Button button, int index) {
        if (isHeartFilled[index]) {
            button.setCompoundDrawablesWithIntrinsicBounds(
                    ContextCompat.getDrawable(Classroom8.this, R.drawable.heart_filled),
                    null, null, null);
        } else {
            button.setCompoundDrawablesWithIntrinsicBounds(
                    ContextCompat.getDrawable(Classroom8.this, R.drawable.heart_unfilled),
                    null, null, null);
        }
    }
